...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><img class="img-fluid" data-bss-hover-animate="pulse" src="{{asset('uploads/web_adresse_images/'.$fav->image)}}" alt="alt text here" style="border: 1px solid rgb(135,135,135) ; height: 100px;"></td>
