...
<nav class="navbar navbar-light navbar-expand-md sticky-top m-auto navigation-clean-search">
    <div class="container"><a class="navbar-brand" href="index.html"><img class="img-fluid" src="assets/img/Asset%2010.png" style="border-radius: 0px;margin-top: 0px;width: 51px;"></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
        <div class="collapse navbar-collapse text-center" id="navcol-1">
            <ul class="navbar-nav mx-auto">
                <li class="nav-item"><a class="nav-link active" href="index.html">Accueil</a></li>
                <li class="nav-item"><a class="nav-link" href="Article_page.html">Articles</a></li>
                <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" aria-expanded="false" data-toggle="dropdown" href="#">Recettes</a>
                    <div class="dropdown-menu"><a class="dropdown-item" href="recettesvégétarien.html">végétarien<br></a><a class="dropdown-item" href="recettesGlutenfree.html">Sans gluten<br></a><a class="dropdown-item" href="recettesPlantb.html">Plant-B</a></div>
                </li>
                <li class="nav-item dropdown"><a class="dropdown-toggle nav-link text-center" aria-expanded="false" data-toggle="dropdown" href="#">Guide</a>
                    <div class="dropdown-menu"><a class="dropdown-item" href="Bonneadresse-1.html">Bonne adresse</a><a class="dropdown-item" href="Bonneadresseweb.html">Bonne adresse web</a></div>
                </li>
...
<footer class="footer-clean" style="margin-top: 1px;background: rgba(255,255,255,0);">
    <div class="container" data-aos="fade-up" data-aos-duration="950">
        ...
        <div class="row justify-content-center" style="margin-bottom: 5px;"><!-- Return to Top -->
            ...
            <div class="col-sm-4 col-md-3 item">
                ...
                <ul>
                    ...
                    <li style="font-family: Poppins, sans-;"><a href="recettesvégétarien.html" style="font-family: 'poppins', ;"><br>Recettes<br></a><a href="Bonneadresse-1.html" style="font-family: 'poppins', ;"><br>Guide<br></a></li>
                </ul>
            </div>
            <div class="col-sm-4 col-md-3 item">
