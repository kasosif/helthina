        ...
        <div class="row people" data-aos="fade-up" data-aos-duration="500" data-aos-delay="500">
            @foreach($adresses as $adresse)
                <div class="col-md-4 col-lg-3 item">
                    <div data-bss-hover-animate="pulse" class="box" style="background: url('{{asset("uploads/adresse_images/".$adresse->image)}}') center / cover no-repeat;border-radius: 10px;border-bottom-left-radius: 0px;border-bottom-right-radius: 50px;border-top-right-radius: 0px;border-top-left-radius: 50px;">
